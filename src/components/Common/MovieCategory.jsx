...
const MovieCategory = React.memo(
  ({
    sectionTitle,
    dataResults,
    totalItemsSearch,
    ...
    const {
      ...
      { category: categorySlug, page: currentPage },
      { skip: !categorySlug },
    );
    ...
    const totalPages = useMemo(() => {
      return totalItemsSearch
        ...
        : Math.ceil(
            (categoryData?.data?.params?.pagination?.totalItems || 0) / limit,
          );
        ...
        return (
          <div className="col-span-full text-center text-white text-lg">
            <div className="flex gap-2 items-center justify-center">
              <IoWarningSharp color="yellow" size={45} />
    ...
    if (isFetching) {
      return (
        <SkeletonForAll withSlider={false} cardCount={24} sectionCount={1} />
      );
    }
      ...
      <div className="min-h-screen custom-page px-0 bg-[#151d25]">
        <Helmet>
          ...
          <link
            ...
            href={
              categorySlug
                ? `https://cuongphim.vercel.app/${categorySlug}`
                : `https://cuongphim.vercel.app/${selectedType}/${selectedSlug}`
            }
          />
        </Helmet>
